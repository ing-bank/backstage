...
// @public
export const techDocsAddonsApi: ExtensionDefinition<{
  config: {};
  configInput: {};
...
// @public
export const techDocsAddonsApiRef: ApiRef<TechDocsAddonsApi>;

// @public (undocumented)
export const TechDocsAddonsBlueprint: ExtensionBlueprint<{
  kind: 'techdocs-addons';
  name: undefined;
  params: {
    addons: JSX.Element[];
  };
  output: ConfigurableExtensionDataRef<JSX.Element[], 'techdocs.addons', {}>;
  inputs: {
    addons: ExtensionInput<
      ConfigurableExtensionDataRef<JSX.Element[], 'techdocs.addons', {}>,
      {
  ...
  configInput: {};
  dataRefs: {
    addons: ConfigurableExtensionDataRef<JSX.Element[], 'techdocs.addons', {}>;
  };
}>;
